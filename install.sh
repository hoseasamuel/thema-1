...
check_token() {
  ...
  if [ "$USER_TOKEN" = "fadhostanakbaik" ]; then
...
while true; do
  ...
  echo -e "${RED}'d$$'     ,$P''''  .    $$$       Auto Installer Fadhost  ${NC}"
  echo -e "${RED}$$$P      d'$     ,    $$P       ------------------------ ${NC}"
  echo -e "${RED}$$$:     $$.     -   ,d$$'       • Telegram : fadhost     ${NC}"
  echo -e "${RED} $$$;     Y$b._    _,d$P'        • Creadit  : FADHOSTOFFC ${NC}"
  echo -e "${RED} Y$$.    '.'''Y$$$$P''           • Support by FadhostOffc ${NC}"
  echo -e "${RED}  '$$b   ''-.__                                           ${NC}"
  echo -e "${RED}   'Y$$                                                   ${NC}"
  echo -e "${RED}     'Y$$                                                 ${NC}"
  echo -e "${RED}       '$$b.                                              ${NC}"
