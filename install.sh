...
while true; do
  ...
  echo -e "           ,ggggggggggggggggg.                                   ${NC}"
  echo -e "${RED}  ,ggggg        gggggggg.                                 ${NC}"
  echo -e "       ,ggg'               'ggg.                                ${NC}"
  echo -e "${RED}',gg       ,ggg.      'ggg:                               ${NC}"
  echo -e "      'ggg      ,gg'''  .    ggg       Auto Installer Fadhost   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "      ggg:     gg.     -   ,ggg       • Telegram : fadhost      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : FADHOSTOFFC  ${NC}"
  echo -e "       ggg.    '.'''ggggggp           • Support by FadhostOffc  ${NC}"
